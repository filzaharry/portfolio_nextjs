        ...
        <div className='max-w-contentContainer mx-auto px-4 py-24'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mt-10 lgl:px-10">
                <ArchiveCard
                    ...
                    link="www.google"
                    desc="Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repudiandae vel quibusdam illum deleniti minima aspernatur quam optio tenetur placeat error architecto ea eaque quidem eius ." />
                <ArchiveCard
                    title="Lorem ipsum dolor "
                    listItem={["ReactJs", "TailwindCSS", "Typescript"]}
                    link="www.google"
