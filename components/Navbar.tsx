        ...
        <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
            ...
            hover:text-textGreen cursor-pointer duration-300 nav-link"
                                    >
                                        ...
                                        >
                                            <span className="text-textGreen">04.</span>Project
                                        </motion.li>
                                    </Link>
                                </ul>
                                <a href="">
                                    <motion.button
                                        ...
                                        className=" my-12 w-32 h-10 rounded-md text-textGreen text-[13px] border border-textGreen hover:bg-hoverColor duration-300"
                                    >
                                        Resume
                                    </motion.button>
                                </a>
